...
if (isset($_SESSION['Correo'])) {
  ...
  $message ='';
	...
	$busqueda = filter_var(strtolower($_POST['buscar']), FILTER_SANITIZE_STRING);

if (!empty($_POST['buscar'])) {
    $records = $conn->prepare('SELECT * FROM recetas WHERE nombre = :busqueda ');
...
<body>
	...
	<div class="header">
		...
		<?php
			...
			<div class="cajon-receta">
					...
					<div class="cajon-imagen-receta">
						...
						<img class="imagen" src="IMAGENES/Error.jpg">
					</div>
		...
		<center><h2 class="titulo">COMENTARIOS</h2></center>
