...
if (isset($_SESSION['Correo'])) {
  ...
  if (!empty($_POST['email_i']) && !empty($_POST['password_i'])) {
	...
	if($Correo!=='admin123@gmail.com'){
		...
		$message .= '<li>ERROR: Solo se permite el ingreso del Usuario final</li>';
	}
...
<body>
	...
	<div class="header">
		...
		<div class="caja-inciarsesion">
			<img src="IMAGENES/INICIARSESION.jpg">
			<div class="inciarsesion">
				<form action="InicioSesion.php" method="POST">
				<center>
				    <input class="cajon-texto" name="email_i" type="email" placeholder="Correo elctronico">
					...
					<label for="Recuerdame">Mantener sesion iniciada</label><br><br>
				...
				<center>
					<p><a style="margin:10px;" href="">¿Olvidaste tu contraseña?</a><a href="Registro.php">Registrar una cuenta nueva</a></p>
					<a  href="InicioSesionAdmin.php"><input type="button" class="boton-enviar" aling="center" value="Ingresar como administrador"></a>
				</center>
			</div>
		</div>
	</div>
